import { Button, FormControl, Grid, IconButton, InputLabel, MenuItem, Pagination, Select, Stack, Typography, useMediaQuery, useTheme, Tabs, Tab, Box, Badge } from '@mui/material'
...
export const AdminDashBoard = () => {
    ...
    // Removed unused: is1200, is800, is700
    ...
    }, [filters, sort, page, dispatch]) // Added dispatch to dependencies
    ...
    <Typography sx={{ cursor: "pointer" }} variant='body2'>Biography</Typography>
    <Typography sx={{ cursor: "pointer" }} variant='body2'>Children</Typography>
    <Typography sx={{ cursor: "pointer" }} variant='body2'>Self-Help</Typography>
    <Typography sx={{ cursor: "pointer" }} variant='body2'>Fantasy</Typography>
    <Typography sx={{ cursor: "pointer" }} variant='body2'>Mystery</Typography>
    ...
    return (
        <>
            ...
            {selectedTab === 0 ? renderProductsDashboard() : <AdminDonations />}
        </>
    )
}